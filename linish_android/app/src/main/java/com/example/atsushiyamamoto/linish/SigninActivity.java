...
public class SigninActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idTextField = (EditText) findViewById(R.id.signinId);
        passwordTextField = (EditText) findViewById(R.id.signinPassword);
        signInButton = (Button) findViewById(R.id.signinButton);
        linkText = (TextView) findViewById(R.id.signupLink);
               ...
               if (errors.isEmpty()) {
                   ...
                   new API() {
                       ...
                       protected String doInBackground(Void... params) {
                           try {
//                               resMap = post("/accounts/signin", formBody);
                               postAsync("/accounts/signin", json, SigninActivity.this, new Callback() {
                                   @Override
                                               ...
                                               public void run() {
                                                   if (resMap.containsKey("code")) {
                                                       ...
                                                       if (Double.compare(code, 400.0) == 0) {
                                                           AlertDialog.Builder alertDlg = new AlertDialog.Builder(SigninActivity.this);
                                                           alertDlg.setTitle("Login Failure");
                                                           alertDlg.setMessage("ユーザーIDまたはパスワードが違います");
                                                       ...
                                                       String accessToken = resMap.get("access_token").toString();
                                                       setAccessToken(accessToken, SigninActivity.this);
                   ...
                   String separator = "\n";
                   String error = StringUtils.join(errors, separator);
                   AlertDialog.Builder alertDlg = new AlertDialog.Builder(SigninActivity.this);
                   alertDlg.setTitle("Login Error");
...
//        mEmailView = (AutoCompleteTextView) findViewById(R.id.signinId);
